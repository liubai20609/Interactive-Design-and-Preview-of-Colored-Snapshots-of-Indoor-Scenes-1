...
class GUIGamut(QWidget):
    ...
    def update_ui(self, pos):
        ...
        #yanhai_begin 20190530
        color = self.ab_grid.findPosTongueImg(pos.y(), pos.x())
        print('this is gui_gamut.py-->update_ui()-->color::')
        print(color)
        #yanhai_end

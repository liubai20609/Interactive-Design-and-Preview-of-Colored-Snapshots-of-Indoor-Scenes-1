...
class ColorizeImageBase():
    ...
    def load_image(self, input_path):
        ...
        # yanhai
        print("Choose Image=====" + input_path)  # test_imgs/mortar_pestle.jpg
        #input_path1 = input_path[:-4] + "1" + input_path[-4:]
        # input_path1=input_path[:-5]+"1"+input_path[-4:]
        #print("Choose Image+1====" + input_path1)
        import matplotlib.pyplot as plt
        #from PIL import Image
        #plt.figure('huidutu1')
        # yanhai
        # yanhai
        #im1 = cv2.cvtColor(cv2.imread(input_path1, 1), cv2.COLOR_BGR2RGB)
        #plt.imshow(im1)
        #plt.show()
        #input_path = input_path[:-4] + "1" + input_path[-4:]
        # yanhai
    ...
    def net_forward(self,input_ab, input_mask):
        ...
        #yanhai_begin
        print("==================================")
        print("This is colorize_image-->>ColorizeImageBase-->net_forward====")
        print("==================================")
        #yanhai_end
...
class ColorizeImageTorch(ColorizeImageBase):
    ...
    def prep_net(self, gpu_id=None, path='', dist=False):
        # yanhai_begin
        print("==================================")
        print("This is colorize_image-->>ColorizeImageTorch-->prep_net====")
        print("==================================")
        # yanhai_end
        import torch
    ...
    def net_forward(self,input_ab, input_mask):
        #yanhai_begin
        print("==================================")
        print("This is colorize_image-->>ColorizeImageTorch-->net_forward====")
        print("==================================")
        #yanhai_end
        # INPUTS
        #     ab         2xXxX     input color patches (non-normalized)
        ...
        # embed()
        #yanhai
        self.save_path='test_imgs/huidutu'
        # np.save(os.path.join(self.save_path, 'self.img_l_mc.npy'), self.img_l_mc)
        # np.save(os.path.join(self.save_path, 'self.input_ab_mc.npy'), self.input_ab_mc)
        # np.save(os.path.join(self.save_path, 'self.input_mask_mult.npy'), self.input_mask_mult)
        print("ColorizeImageTorch--->net_forward")
        ...
        #yanhai
        # np.save(os.path.join(self.save_path, 'output_ab.npy'),output_ab)
        #yanhai_end
        ...
        #yanhai begin
        # np.save(os.path.join(self.save_path, 'self.output_rgb.npy'), self.output_rgb)
        #yanhai_end
        self._set_out_ab_()
        #yanhai_begin

        print("=============saving all npy==============")
        #yanhai_end
        return self.output_rgb
...
class ColorizeImageTorchDist(ColorizeImageTorch):
    ...
    def net_forward(self,input_ab, input_mask):
        # yanhai_begin
        print("==================================")
        print("This is colorize_image-->>ColorizeImageTorchDist-->net_forward====")
        print("==================================")
        # yanhai_end
        # INPUTS
        #     ab         2xXxX     input color patches (non-normalized)
        ...
        if ColorizeImageBase.net_forward(self,input_ab, input_mask) == -1:
            return -1
        #yanhai
        print("ColorizeImageTorchDist--->net_forward")
        # set distribution
        ...
        ## change function_return and dist_ab user : pool
        # function_return=np.ones(function_return.shape)
        # self.dist_ab=np.ones(self.dist_ab.shape)
        ## end
